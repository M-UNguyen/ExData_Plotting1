...
# plot1.R assumes that the "Individual household electric power
...
#######################################################################
# STEP 2:  Create a histogram of the Global_active_power values and
# save it to a PNG file named plot1.png.
#
png("plot1.png")
