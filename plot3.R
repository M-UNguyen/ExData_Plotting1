...
# plot3.R assumes that the "Individual household electric power
# consumption" data set has been downloaded, unzipped, and placed
# in the same working directory as the R code.
#
...
####################################################################
# Step 2:  Create a line graph, with legend, of the 3 Sub_metering
